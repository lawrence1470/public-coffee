...
export default function Navigation() {
  ...
  // Determine if navigation should be dark based on current route
  useEffect(() => {
    const darkPages = ["/about-us"];
    setIsDark(darkPages.includes(pathname));
  }, [pathname]);
  ...
  useEffect(() => {
    ...
    const menuButtonIcon = menuButton.querySelector(
          ...
          <nav className={styles.navRow}>
            <Link href="/" aria-label="home" className={styles.navLogoRow}>
              <img
                src={
                  isDark
                    ? "/coffeebird-white-logo.svg"
                    : "/coffeebird-black-logo.svg"
                }
                alt="CoffeeBird"
        ...
        <nav className={styles.menu}>
          ...
          <div className={styles.menuInner}>
            ...
            <div className={styles.menuDetails}>
              <p data-menu-fade="" className={styles.pSmall}>
                Socials
              </p>
              <div className={styles.socialsRow}>
                <a
                  data-menu-fade=""
                  href="#"
                  className={`${styles.pLarge} ${styles.textLink}`}
                >
                  Instagram
                </a>
                <a
